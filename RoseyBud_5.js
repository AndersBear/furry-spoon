class Example_5 extends Phaser.Scene {
    constructor() {
        super();
        ...
        this.rowLengths = [4, 3, 2, 3, 4]; // Define the length of each row
        this.squareSize = 80;
    ...
    initializePieces() {
        ...
        this.createPiece(0, 1, 'White', 'Queen');
        // Black pieces
        this.createPiece(4, 2, 'Black', 'King');
        this.createPiece(4, 3, 'Black', 'Queen');
    }
...
window.phaserGame = new Phaser.Game(config_5);
