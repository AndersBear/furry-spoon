class Example_11 extends Phaser.Scene {
    constructor() {
        super();
        ...
        this.rowLengths = [2, 2, 2, 3, 6]; // Define the length of each row
        this.squareSize = 80;
    ...
    initializePieces() {
        ...
        this.createPiece(1, 1, 'White', 'Rook');
        // Black pieces
        this.createPiece(4, 0, 'Black', 'King');
        this.createPiece(3, 2, 'Black', 'Rook');
        this.createPiece(4, 5, 'Black', 'Rook');
    }
    createPiece(row, col, color, type) {
        ...
        const piece = this.add.text(x, y, type === 'King' ? 'K' : 'R', {
            fontSize: '48px',
...
window.phaserGame = new Phaser.Game(config_11);