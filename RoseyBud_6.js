class Example_6 extends Phaser.Scene {
    constructor() {
        super();
        ...
        this.rowLengths = [4, 2, 2, 4]; // Define the length of each row
        this.squareSize = 80;
    ...
    initializePieces() {
        ...
        // White pieces
        this.createPiece(3, 3, 'White', 'King');
        this.createPiece(3, 2, 'White', 'Queen');
        // Black pieces
        this.createPiece(0, 3, 'Black', 'King');
        this.createPiece(0, 2, 'Black', 'Queen');
    }
...
window.phaserGame = new Phaser.Game(config_6);
