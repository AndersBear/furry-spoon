class Example_9 extends Phaser.Scene {
    constructor() {
        super();
        ...
        this.rowLengths = [2, 2, 3, 2, 3]; // Define the length of each row
        this.squareSize = 80;
    ...
    initializePieces() {
        ...
        this.createPiece(1, 0, 'Black', 'Rook');
    }
...
window.phaserGame = new Phaser.Game(config_9);
