class Example_12 extends Phaser.Scene {
    constructor() {
        super();
        ...
        this.rowLengths = [4, 5, 5, 5, 6]; // Define the length of each row
        this.squareSize = 80;
    ...
    initializePieces() {
        ...
        // White pieces
        this.createPiece(4, 2, 'White', 'King');
        this.createPiece(3, 4, 'White', 'Rook');
        this.createPiece(4, 3, 'White', 'Rook');
        // Black pieces
        this.createPiece(0, 2, 'Black', 'King');
        this.createPiece(0, 1, 'Black', 'Rook');
        this.createPiece(0, 0, 'Black', 'Queen');
    }
    createPiece(row, col, color, type) {
        ...
        const piece = this.add.text(x, y, type === 'King' ? 'K' : type === 'Queen' ? 'Q' : 'R', {
            fontSize: '48px',
...
window.phaserGame = new Phaser.Game(config_12);