class Example_10 extends Phaser.Scene {
    constructor() {
        super();
        ...
        this.rowLengths = [2, 3, 3, 2, 2]; // Define the length of each row
        this.squareSize = 80;
    ...
    initializePieces() {
        ...
        this.createPiece(1, 2, 'White', 'Bishop');
        // Black pieces
        this.createPiece(4, 1, 'Black', 'King');
        this.createPiece(2, 2, 'Black', 'Bishop');
    }
    createPiece(row, col, color, type) {
        ...
        const piece = this.add.text(x, y, type === 'King' ? 'K' : 'B', {
            fontSize: '48px',
...
window.phaserGame = new Phaser.Game(config_10);
