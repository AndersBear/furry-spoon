class Example_13 extends Phaser.Scene {
    constructor() {
        super();
        ...
        this.rowLengths = [5, 6, 4, 5, 6]; // Define the length of each row
        this.squareSize = 80;
    ...
    initializePieces() {
        ...
        this.createPiece(4, 5, 'White', 'Bishop');
        this.createPiece(0, 2, 'White', 'Bishop');
        this.createPiece(0, 3, 'White', 'Rook');

        // Black pieces
        this.createPiece(4, 1, 'Black', 'King');
        this.createPiece(2, 2, 'Black', 'Rook');
        this.createPiece(3, 1, 'Black', 'Queen');  
    }
    createPiece(row, col, color, type) {
        ...
        const piece = this.add.text(x, y, type === 'King' ? 'K' : type === 'Queen' ? 'Q' : type === 'Rook' ? 'R' : 'B', {
            fontSize: '48px',
...
window.phaserGame = new Phaser.Game(config_13);