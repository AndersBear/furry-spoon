class Example_7 extends Phaser.Scene {
    constructor() {
        super();
        ...
        this.rowLengths = [2, 3, 4, 4]; // Define the length of each row
        this.squareSize = 80;
    ...
    initializePieces() {
        ...
        // White pieces
        this.createPiece(3, 0, 'White', 'King');
        this.createPiece(0, 1, 'White', 'Rook');
        // Black pieces
        this.createPiece(2, 3, 'Black', 'King');
        this.createPiece(1, 2, 'Black', 'Rook');
    }
...
window.phaserGame = new Phaser.Game(config_7);
