class Example_2 extends Phaser.Scene {
    constructor() {
        ...
        this.rowLengths = [4, 3, 2, 1]; // Define the length of each row
        this.squareSize = 80;
    ...
    initializePieces() {
        ...
        this.createPiece(2, 0, 'White', 'Queen');
        // Black pieces
...
window.phaserGame = new Phaser.Game(config_2);
